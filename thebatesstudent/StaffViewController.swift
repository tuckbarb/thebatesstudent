...
//
//        news_ed.frame = CGRect(x: 22, y: 163, width: 120, height: 67)
//        news_ed.text = "Managing Editor:\nChristina Perrone\nAssistant Editor:\nMadeline Polkinghorn "
//        news_ed.numberOfLines = 4
//        news_ed.textAlignment = .center
//        news_ed.textColor = UIColor.black
//        news_ed.font = UIFont(name: "Georgia", size: 10)
//
//        self.view.addSubview(news_ed)
//
